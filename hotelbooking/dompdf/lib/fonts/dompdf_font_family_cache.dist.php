...
return function ($rootDir) {
    ...
    return [
		...
		'times_new_roman' =>
            [
                'normal' => $distFontDir . '/Times_New_Roman',
                'bold' => $distFontDir . '/Times_New_Roman_Bold',
                'italic' => $distFontDir . '/Times_New_Roman_Italic',
                'bold_italic' => $distFontDir . '/Times_New_Roman_Bold_Italic'
            ],
        'courier' =>
            [
